...
Defines the ContextBuilder service that composes the full system prompt for the tutor by combining the base prompt template with exercise metadata, student code, and activity context.
