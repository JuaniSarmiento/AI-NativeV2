...
Defines the GuardrailsProcessor service that analyzes LLM responses post-stream and detects pedagogical violations (excessive code, direct solutions, non-socratic responses). Emits governance events and generates corrective follow-up messages.
